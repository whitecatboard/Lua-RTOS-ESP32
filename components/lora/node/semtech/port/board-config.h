...
#if CONFIG_LUA_RTOS_LORA_RST == -1
#define RADIO_RESET                                 -2
#else
#define RADIO_RESET									CONFIG_LUA_RTOS_LORA_RST
#endif

#define RADIO_MOSI                                  PA_7
#define RADIO_MISO                                  PA_6
#define RADIO_SCLK                                  PA_5
#define RADIO_NSS                                   CONFIG_LUA_RTOS_LORA_CS

#define RADIO_DIO_0                                 CONFIG_LUA_RTOS_LORA_DIO0
#define RADIO_DIO_1                                 CONFIG_LUA_RTOS_LORA_DIO1
#define RADIO_DIO_2                                 CONFIG_LUA_RTOS_LORA_DIO2
#define RADIO_DIO_3                                 -1
#define RADIO_DIO_4                                 -1
#define RADIO_DIO_5                                 -1

#define RADIO_ANT_SWITCH_HF                         -1
#define RADIO_ANT_SWITCH_LF                         -1

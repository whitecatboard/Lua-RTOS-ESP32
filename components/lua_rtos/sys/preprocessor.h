/*
 * Lua RTOS, some useful preprocessor macros
 *
...
#define PREP_TOSTRING_PASTER(x) #x
#define PREP_TOSTRING_EVALUATOR(x) PREP_TOSTRING_PASTER(x)
#define PREP_TOSTRING(x) PREP_TOSTRING_EVALUATOR(x)

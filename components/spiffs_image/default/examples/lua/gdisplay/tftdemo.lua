...
tftdemo = {
	dispType = gdisplay.ST7735G, -- or gdisplay.ST7735B, gdisplay.ST7735, gdisplay.ST7735G
	maxx = 128,
	maxy = 160,
	miny = 12,
	touch = false,
	...
	images = {
		jpg = {"/examples/lua/gdisplay/tiger240.jpg", 0, 0},
		bmp = {"/examples/lua/gdisplay/tiger.bmp", 0, 0}
	}
}

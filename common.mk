...
$(1)_CPP_BASE = $(Q) $(CPP) $$(addprefix -I,$$(INC_DIRS)) $$(addprefix -I,$$($(1)_INC_DIR)) $$($(1)_CPPFLAGS)
...
flash: all
	...
	$(CROSS)objcopy -O ihex --change-addresses=0x80000000 $(PROGRAM_OUT) $(FIRMWARE_DIR)LuaOS_V1.hex
endif

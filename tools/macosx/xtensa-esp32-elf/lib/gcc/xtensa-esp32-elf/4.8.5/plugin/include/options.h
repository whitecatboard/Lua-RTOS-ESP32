...
enum opt_code
{
  ...
  OPT_mconst16 = 1038,                       /* -mconst16 */
  OPT_mforce_no_pic = 1039,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1040, */              /* -mfused-madd */
  OPT_mlongcalls = 1041,                     /* -mlongcalls */
  OPT_mserialize_volatile = 1042,            /* -mserialize-volatile */
  OPT_mtarget_align = 1043,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1044,         /* -mtext-section-literals */
  OPT_n = 1045,                              /* -n */
  OPT_no_canonical_prefixes = 1046,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1047,              /* -no-integrated-cpp */
  OPT_nocpp = 1048,                          /* -nocpp */
  OPT_nodefaultlibs = 1049,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1050,                   /* -nostartfiles */
  OPT_nostdinc = 1051,                       /* -nostdinc */
  OPT_nostdinc__ = 1052,                     /* -nostdinc++ */
  OPT_nostdlib = 1053,                       /* -nostdlib */
  OPT_o = 1054,                              /* -o */
  OPT_p = 1055,                              /* -p */
  OPT_pass_exit_codes = 1056,                /* -pass-exit-codes */
  /* OPT_pedantic = 1057, */                 /* -pedantic */
  OPT_pedantic_errors = 1058,                /* -pedantic-errors */
  OPT_pg = 1059,                             /* -pg */
  OPT_pie = 1060,                            /* -pie */
  OPT_pipe = 1061,                           /* -pipe */
  OPT_print_file_name_ = 1062,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1063,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1064,          /* -print-multi-directory */
  OPT_print_multi_lib = 1065,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1066,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1067,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1068,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1069,               /* -print-prog-name= */
  OPT_print_search_dirs = 1070,              /* -print-search-dirs */
  OPT_print_sysroot = 1071,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1072,   /* -print-sysroot-headers-suffix */
  ...
  OPT_static_libasan = 1086,                 /* -static-libasan */
  OPT_static_libgcc = 1087,                  /* -static-libgcc */
  OPT_static_libgcj = 1088,                  /* -static-libgcj */
  OPT_static_libgfortran = 1089,             /* -static-libgfortran */
  OPT_static_libgo = 1090,                   /* -static-libgo */
  OPT_static_libstdc__ = 1091,               /* -static-libstdc++ */
  OPT_static_libtsan = 1092,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1093, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1094, */                /* -std=c++0x */
  OPT_std_c__11 = 1095,                      /* -std=c++11 */
  OPT_std_c__1y = 1096,                      /* -std=c++1y */
  OPT_std_c__98 = 1097,                      /* -std=c++98 */
  OPT_std_c11 = 1098,                        /* -std=c11 */
  /* OPT_std_c1x = 1099, */                  /* -std=c1x */
  /* OPT_std_c89 = 1100, */                  /* -std=c89 */
  OPT_std_c90 = 1101,                        /* -std=c90 */
  OPT_std_c99 = 1102,                        /* -std=c99 */
  /* OPT_std_c9x = 1103, */                  /* -std=c9x */
  OPT_std_f2003 = 1104,                      /* -std=f2003 */
  OPT_std_f2008 = 1105,                      /* -std=f2008 */
  OPT_std_f2008ts = 1106,                    /* -std=f2008ts */
  OPT_std_f95 = 1107,                        /* -std=f95 */
  OPT_std_gnu = 1108,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1109, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1110, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1111,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1112,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1113,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1114,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1115, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1116, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1117,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1118,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1119, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1120, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1121,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1122, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1123, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1124, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1125,                     /* -std=legacy */
  OPT_symbolic = 1126,                       /* -symbolic */
  OPT_t = 1127,                              /* -t */
  OPT_time = 1128,                           /* -time */
  OPT_time_ = 1129,                          /* -time= */
  OPT_traditional = 1130,                    /* -traditional */
  OPT_traditional_cpp = 1131,                /* -traditional-cpp */
  OPT_trigraphs = 1132,                      /* -trigraphs */
  OPT_u = 1133,                              /* -u */
  OPT_undef = 1134,                          /* -undef */
  OPT_v = 1135,                              /* -v */
  OPT_version = 1136,                        /* -version */
  OPT_w = 1137,                              /* -w */
  OPT_wrapper = 1138,                        /* -wrapper */
  OPT_x = 1139,                              /* -x */
  OPT_z = 1140,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,

...
#define MASK_FORCE_L32 (1 << 1)
#define MASK_FORCE_NO_PIC (1 << 2)
#define MASK_SERIALIZE_VOLATILE (1 << 3)

#define TARGET_CONST16 ((target_flags & MASK_CONST16) != 0)
#define TARGET_FORCE_L32 ((target_flags & MASK_FORCE_L32) != 0)
...
enum opt_code
{
  ...
  OPT_mforce_l32 = 1039,                     /* -mforce-l32 */
  OPT_mforce_no_pic = 1040,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1041, */              /* -mfused-madd */
  OPT_mlongcalls = 1042,                     /* -mlongcalls */
  OPT_mserialize_volatile = 1043,            /* -mserialize-volatile */
  OPT_mtarget_align = 1044,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1045,         /* -mtext-section-literals */
  OPT_n = 1046,                              /* -n */
  OPT_no_canonical_prefixes = 1047,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1048,              /* -no-integrated-cpp */
  OPT_nocpp = 1049,                          /* -nocpp */
  OPT_nodefaultlibs = 1050,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1051,                   /* -nostartfiles */
  OPT_nostdinc = 1052,                       /* -nostdinc */
  OPT_nostdinc__ = 1053,                     /* -nostdinc++ */
  OPT_nostdlib = 1054,                       /* -nostdlib */
  OPT_o = 1055,                              /* -o */
  OPT_p = 1056,                              /* -p */
  OPT_pass_exit_codes = 1057,                /* -pass-exit-codes */
  /* OPT_pedantic = 1058, */                 /* -pedantic */
  OPT_pedantic_errors = 1059,                /* -pedantic-errors */
  OPT_pg = 1060,                             /* -pg */
  OPT_pie = 1061,                            /* -pie */
  OPT_pipe = 1062,                           /* -pipe */
  OPT_print_file_name_ = 1063,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1064,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1065,          /* -print-multi-directory */
  OPT_print_multi_lib = 1066,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1067,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1068,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1069,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1070,               /* -print-prog-name= */
  OPT_print_search_dirs = 1071,              /* -print-search-dirs */
  OPT_print_sysroot = 1072,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1073,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1074,                          /* -quiet */
  OPT_r = 1075,                              /* -r */
  OPT_rdynamic = 1076,                       /* -rdynamic */

...
#define ggc_alloc_mips16_local_alias() ((struct mips16_local_alias *)(ggc_internal_alloc_stat (sizeof (struct mips16_local_alias) MEM_STAT_INFO)))
#define ggc_alloc_cleared_mips16_local_alias() ((struct mips16_local_alias *)(ggc_internal_cleared_alloc_stat (sizeof (struct mips16_local_alias) MEM_STAT_INFO)))
#define ggc_alloc_vec_mips16_local_alias(n) ((struct mips16_local_alias *)(ggc_internal_vec_alloc_stat (sizeof (struct mips16_local_alias), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_mips16_local_alias(n) ((struct mips16_local_alias *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct mips16_local_alias), n MEM_STAT_INFO)))
#define ggc_alloc_mflip_mips16_entry() ((struct mflip_mips16_entry *)(ggc_internal_alloc_stat (sizeof (struct mflip_mips16_entry) MEM_STAT_INFO)))
#define ggc_alloc_cleared_mflip_mips16_entry() ((struct mflip_mips16_entry *)(ggc_internal_cleared_alloc_stat (sizeof (struct mflip_mips16_entry) MEM_STAT_INFO)))
#define ggc_alloc_vec_mflip_mips16_entry(n) ((struct mflip_mips16_entry *)(ggc_internal_vec_alloc_stat (sizeof (struct mflip_mips16_entry), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_mflip_mips16_entry(n) ((struct mflip_mips16_entry *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct mflip_mips16_entry), n MEM_STAT_INFO)))
#define ggc_alloc_mips_frame_header_usage() ((struct mips_frame_header_usage *)(ggc_internal_alloc_stat (sizeof (struct mips_frame_header_usage) MEM_STAT_INFO)))
#define ggc_alloc_cleared_mips_frame_header_usage() ((struct mips_frame_header_usage *)(ggc_internal_cleared_alloc_stat (sizeof (struct mips_frame_header_usage) MEM_STAT_INFO)))
#define ggc_alloc_vec_mips_frame_header_usage(n) ((struct mips_frame_header_usage *)(ggc_internal_vec_alloc_stat (sizeof (struct mips_frame_header_usage), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_mips_frame_header_usage(n) ((struct mips_frame_header_usage *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct mips_frame_header_usage), n MEM_STAT_INFO)))
#define ggc_alloc_mips_frame_info() ((struct mips_frame_info *)(ggc_internal_alloc_stat (sizeof (struct mips_frame_info) MEM_STAT_INFO)))
#define ggc_alloc_cleared_mips_frame_info() ((struct mips_frame_info *)(ggc_internal_cleared_alloc_stat (sizeof (struct mips_frame_info) MEM_STAT_INFO)))
#define ggc_alloc_vec_mips_frame_info(n) ((struct mips_frame_info *)(ggc_internal_vec_alloc_stat (sizeof (struct mips_frame_info), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_mips_frame_info(n) ((struct mips_frame_info *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct mips_frame_info), n MEM_STAT_INFO)))
...
#define ggc_alloc_vec_dummy_info_ref_va_gc_() ((vec<dummy_info_ref,va_gc> *)(ggc_internal_alloc_stat (sizeof (vec<dummy_info_ref,va_gc>) MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_dummy_info_ref_va_gc_() ((vec<dummy_info_ref,va_gc> *)(ggc_internal_cleared_alloc_stat (sizeof (vec<dummy_info_ref,va_gc>) MEM_STAT_INFO)))
#define ggc_alloc_vec_vec_dummy_info_ref_va_gc_(n) ((vec<dummy_info_ref,va_gc> *)(ggc_internal_vec_alloc_stat (sizeof (vec<dummy_info_ref,va_gc>), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_vec_dummy_info_ref_va_gc_(n) ((vec<dummy_info_ref,va_gc> *)(ggc_internal_cleared_vec_alloc_stat (sizeof (vec<dummy_info_ref,va_gc>), n MEM_STAT_INFO)))
#define ggc_alloc_dummy_info_t() ((struct dummy_info_t *)(ggc_internal_alloc_stat (sizeof (struct dummy_info_t) MEM_STAT_INFO)))
#define ggc_alloc_cleared_dummy_info_t() ((struct dummy_info_t *)(ggc_internal_cleared_alloc_stat (sizeof (struct dummy_info_t) MEM_STAT_INFO)))
#define ggc_alloc_vec_dummy_info_t(n) ((struct dummy_info_t *)(ggc_internal_vec_alloc_stat (sizeof (struct dummy_info_t), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_dummy_info_t(n) ((struct dummy_info_t *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct dummy_info_t), n MEM_STAT_INFO)))
#define ggc_alloc_vec_compact_info_ref_va_gc_() ((vec<compact_info_ref,va_gc> *)(ggc_internal_alloc_stat (sizeof (vec<compact_info_ref,va_gc>) MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_compact_info_ref_va_gc_() ((vec<compact_info_ref,va_gc> *)(ggc_internal_cleared_alloc_stat (sizeof (vec<compact_info_ref,va_gc>) MEM_STAT_INFO)))
#define ggc_alloc_vec_vec_compact_info_ref_va_gc_(n) ((vec<compact_info_ref,va_gc> *)(ggc_internal_vec_alloc_stat (sizeof (vec<compact_info_ref,va_gc>), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_vec_compact_info_ref_va_gc_(n) ((vec<compact_info_ref,va_gc> *)(ggc_internal_cleared_vec_alloc_stat (sizeof (vec<compact_info_ref,va_gc>), n MEM_STAT_INFO)))
#define ggc_alloc_compact_info_t() ((struct compact_info_t *)(ggc_internal_alloc_stat (sizeof (struct compact_info_t) MEM_STAT_INFO)))
#define ggc_alloc_cleared_compact_info_t() ((struct compact_info_t *)(ggc_internal_cleared_alloc_stat (sizeof (struct compact_info_t) MEM_STAT_INFO)))
#define ggc_alloc_vec_compact_info_t(n) ((struct compact_info_t *)(ggc_internal_vec_alloc_stat (sizeof (struct compact_info_t), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_compact_info_t(n) ((struct compact_info_t *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct compact_info_t), n MEM_STAT_INFO)))
#define ggc_alloc_vec_chain_ref_va_gc_() ((vec<chain_ref,va_gc> *)(ggc_internal_alloc_stat (sizeof (vec<chain_ref,va_gc>) MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_chain_ref_va_gc_() ((vec<chain_ref,va_gc> *)(ggc_internal_cleared_alloc_stat (sizeof (vec<chain_ref,va_gc>) MEM_STAT_INFO)))
#define ggc_alloc_vec_vec_chain_ref_va_gc_(n) ((vec<chain_ref,va_gc> *)(ggc_internal_vec_alloc_stat (sizeof (vec<chain_ref,va_gc>), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_vec_chain_ref_va_gc_(n) ((vec<chain_ref,va_gc> *)(ggc_internal_cleared_vec_alloc_stat (sizeof (vec<chain_ref,va_gc>), n MEM_STAT_INFO)))
#define ggc_alloc_chain_t() ((struct chain_t *)(ggc_internal_alloc_stat (sizeof (struct chain_t) MEM_STAT_INFO)))
#define ggc_alloc_cleared_chain_t() ((struct chain_t *)(ggc_internal_cleared_alloc_stat (sizeof (struct chain_t) MEM_STAT_INFO)))
#define ggc_alloc_vec_chain_t(n) ((struct chain_t *)(ggc_internal_vec_alloc_stat (sizeof (struct chain_t), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_chain_t(n) ((struct chain_t *)(ggc_internal_cleared_vec_alloc_stat (sizeof (struct chain_t), n MEM_STAT_INFO)))
...
#define ggc_alloc_dummy_info_ref() ((dummy_info_ref *)(ggc_internal_alloc_stat (sizeof (dummy_info_ref) MEM_STAT_INFO)))
#define ggc_alloc_cleared_dummy_info_ref() ((dummy_info_ref *)(ggc_internal_cleared_alloc_stat (sizeof (dummy_info_ref) MEM_STAT_INFO)))
#define ggc_alloc_vec_dummy_info_ref(n) ((dummy_info_ref *)(ggc_internal_vec_alloc_stat (sizeof (dummy_info_ref), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_dummy_info_ref(n) ((dummy_info_ref *)(ggc_internal_cleared_vec_alloc_stat (sizeof (dummy_info_ref), n MEM_STAT_INFO)))
#define ggc_alloc_compact_info_ref() ((compact_info_ref *)(ggc_internal_alloc_stat (sizeof (compact_info_ref) MEM_STAT_INFO)))
#define ggc_alloc_cleared_compact_info_ref() ((compact_info_ref *)(ggc_internal_cleared_alloc_stat (sizeof (compact_info_ref) MEM_STAT_INFO)))
#define ggc_alloc_vec_compact_info_ref(n) ((compact_info_ref *)(ggc_internal_vec_alloc_stat (sizeof (compact_info_ref), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_compact_info_ref(n) ((compact_info_ref *)(ggc_internal_cleared_vec_alloc_stat (sizeof (compact_info_ref), n MEM_STAT_INFO)))
#define ggc_alloc_chain_ref() ((chain_ref *)(ggc_internal_alloc_stat (sizeof (chain_ref) MEM_STAT_INFO)))
#define ggc_alloc_cleared_chain_ref() ((chain_ref *)(ggc_internal_cleared_alloc_stat (sizeof (chain_ref) MEM_STAT_INFO)))
#define ggc_alloc_vec_chain_ref(n) ((chain_ref *)(ggc_internal_vec_alloc_stat (sizeof (chain_ref), n MEM_STAT_INFO)))
#define ggc_alloc_cleared_vec_chain_ref(n) ((chain_ref *)(ggc_internal_cleared_vec_alloc_stat (sizeof (chain_ref), n MEM_STAT_INFO)))
...
#define gt_ggc_m_23mips_frame_header_usage(X) do { \
  if (X != NULL) gt_ggc_mx_mips_frame_header_usage (X);\
  } while (0)
extern void gt_ggc_mx_mips_frame_header_usage (void *);
...
#define gt_ggc_m_25vec_dummy_info_ref_va_gc_(X) do { \
  if (X != NULL) gt_ggc_mx_vec_dummy_info_ref_va_gc_ (X);\
  } while (0)
extern void gt_ggc_mx_vec_dummy_info_ref_va_gc_ (void *);
#define gt_ggc_m_12dummy_info_t(X) do { \
  if (X != NULL) gt_ggc_mx_dummy_info_t (X);\
  } while (0)
extern void gt_ggc_mx_dummy_info_t (void *);
#define gt_ggc_m_27vec_compact_info_ref_va_gc_(X) do { \
  if (X != NULL) gt_ggc_mx_vec_compact_info_ref_va_gc_ (X);\
  } while (0)
extern void gt_ggc_mx_vec_compact_info_ref_va_gc_ (void *);
#define gt_ggc_m_14compact_info_t(X) do { \
  if (X != NULL) gt_ggc_mx_compact_info_t (X);\
  } while (0)
extern void gt_ggc_mx_compact_info_t (void *);
#define gt_ggc_m_20vec_chain_ref_va_gc_(X) do { \
  if (X != NULL) gt_ggc_mx_vec_chain_ref_va_gc_ (X);\
  } while (0)
extern void gt_ggc_mx_vec_chain_ref_va_gc_ (void *);
#define gt_ggc_m_7chain_t(X) do { \
  if (X != NULL) gt_ggc_mx_chain_t (X);\
  } while (0)
extern void gt_ggc_mx_chain_t (void *);
...
extern void gt_ggc_m_P23mips_frame_header_usage4htab (void *);
...
#define gt_pch_n_23mips_frame_header_usage(X) do { \
  if (X != NULL) gt_pch_nx_mips_frame_header_usage (X);\
  } while (0)
extern void gt_pch_nx_mips_frame_header_usage (void *);
...
#define gt_pch_n_25vec_dummy_info_ref_va_gc_(X) do { \
  if (X != NULL) gt_pch_nx_vec_dummy_info_ref_va_gc_ (X);\
  } while (0)
extern void gt_pch_nx_vec_dummy_info_ref_va_gc_ (void *);
#define gt_pch_n_12dummy_info_t(X) do { \
  if (X != NULL) gt_pch_nx_dummy_info_t (X);\
  } while (0)
extern void gt_pch_nx_dummy_info_t (void *);
#define gt_pch_n_27vec_compact_info_ref_va_gc_(X) do { \
  if (X != NULL) gt_pch_nx_vec_compact_info_ref_va_gc_ (X);\
  } while (0)
extern void gt_pch_nx_vec_compact_info_ref_va_gc_ (void *);
#define gt_pch_n_14compact_info_t(X) do { \
  if (X != NULL) gt_pch_nx_compact_info_t (X);\
  } while (0)
extern void gt_pch_nx_compact_info_t (void *);
#define gt_pch_n_20vec_chain_ref_va_gc_(X) do { \
  if (X != NULL) gt_pch_nx_vec_chain_ref_va_gc_ (X);\
  } while (0)
extern void gt_pch_nx_vec_chain_ref_va_gc_ (void *);
#define gt_pch_n_7chain_t(X) do { \
  if (X != NULL) gt_pch_nx_chain_t (X);\
  } while (0)
extern void gt_pch_nx_chain_t (void *);
...
extern void gt_pch_n_P23mips_frame_header_usage4htab (void *);
...
extern void gt_pch_p_18mflip_mips16_entry
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_23mips_frame_header_usage
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_16string_pool_data
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_25vec_dummy_info_ref_va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_12dummy_info_t
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_27vec_compact_info_ref_va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_14compact_info_t
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_20vec_chain_ref_va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_7chain_t
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_P18mflip_mips16_entry4htab
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_P23mips_frame_header_usage4htab
    (void *, void *, gt_pointer_operator, void *);
...
extern void * ggc_alloc_splay_tree_mips16_local_alias_htab (int, void *);
extern void * ggc_alloc_splay_tree_mflip_mips16_entry_htab (int, void *);
extern void * ggc_alloc_splay_tree_mips_frame_header_usage_htab (int, void *);

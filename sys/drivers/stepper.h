...
#define STEPPER_RMT_NANOS_PER_TICK_FLOAT 25.0f

// RMT frequency
#define STEPPER_RMT_FREQ (1000000000 / STEPPER_RMT_NANOS_PER_TICK)

// Step pulse duration in RMT ticks
#define STEPPER_PULSE_TICKS (STEPPER_PULSE_NANOS / STEPPER_RMT_NANOS_PER_TICK)

#define STEPPER_SECONDS_TO_RMT_TICKS (1000000000.0f / STEPPER_RMT_NANOS_PER_TICK_FLOAT)

#define STEPPER_RMT_BUFF_SIZE 64
#define STEPPER_RMT_HALF_BUFF_SIZE (STEPPER_RMT_BUFF_SIZE >> 1)

//#define STEPPER_RMT_DATA_SIZE 3200
#define STEPPER_RMT_DATA_SIZE 3200
//#define STEPPER_RMT_DATA_SIZE 64

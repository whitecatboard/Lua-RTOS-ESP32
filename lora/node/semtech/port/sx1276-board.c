...
{
    GpioInit( &SX1276.Spi.Nss, CONFIG_LUA_RTOS_LORA_CS, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 1 );

    GpioInit( &SX1276.DIO0, CONFIG_LUA_RTOS_LORA_DIO0, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0 );
    GpioInit( &SX1276.DIO1, CONFIG_LUA_RTOS_LORA_DIO1, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0 );
    GpioInit( &SX1276.DIO2, CONFIG_LUA_RTOS_LORA_DIO2, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0 );
...
void SX1276IoDeInit( void )
{
    ...
    GpioInit( &SX1276.DIO0, CONFIG_LUA_RTOS_LORA_DIO0, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
    GpioInit( &SX1276.DIO1, CONFIG_LUA_RTOS_LORA_DIO1, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
    GpioInit( &SX1276.DIO2, CONFIG_LUA_RTOS_LORA_DIO2, PIN_INPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
